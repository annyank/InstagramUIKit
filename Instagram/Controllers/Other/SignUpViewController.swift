...
class SignUpViewController: UIViewController, UITextFieldDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    override func viewDidLayoutSubviews() {
        ...
        signUpButton.frame = CGRect(x: 25, y: passwordField.bottom+10, width: view.width-50, height: 50)
        termsButton.frame = CGRect(x: 25, y: signUpButton.bottom+50, width: view.width-50, height: 40)
