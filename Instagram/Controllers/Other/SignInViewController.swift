...
class SignInViewController: UIViewController, UITextFieldDelegate {
    ...
    override func viewDidLayoutSubviews() {
        ...
        signInButton.frame = CGRect(x: 25, y: passwordField.bottom+10, width: view.width-50, height: 50)
        createAccountButton.frame = CGRect(x: 25, y: signInButton.bottom+20, width: view.width-50, height: 50)
        termsButton.frame = CGRect(x: 25, y: createAccountButton.bottom+50, width: view.width-50, height: 40)
        privacyButton.frame = CGRect(x: 25, y: termsButton.bottom+10, width: view.width-50, height: 40)
    }
